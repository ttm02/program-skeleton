/**
 * The code in this test case is entirely copied
 * from https://www.sanfoundry.com/c-program-perform-lu-decomposition-any-matrix/
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
// TODO: CHANGED - added larger example
double A8[][8] = {
    { 1, 2, 3, 4, 5, 6, 7, 8 },
    { 2, 3, 4, 5, 6, 7, 8, 9 },
    { 3, 4, 5, 6, 7, 8, 9, 10 },
