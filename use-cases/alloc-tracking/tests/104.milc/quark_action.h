...
#define ASQ_OPTIMIZED_FORCE
    ...
    { XUP, NODIR, NODIR, NODIR, NODIR, NODIR },	/* One Link */
    { XUP, XUP, XUP, NODIR, NODIR, NODIR },	/* Naik */
    { YUP, XUP, YDOWN, NODIR, NODIR, NODIR },	/* Staple */
    { YUP, ZUP, XUP, ZDOWN, YDOWN, NODIR },	/* 5-link for flavor sym. */
    { YUP, ZUP, TUP, XUP, TDOWN, ZDOWN, YDOWN},	/* 7-link for flavor sym. */
    { YUP, YUP, XUP, YDOWN, YDOWN, NODIR },	/* 5-link compensation    */
    };
