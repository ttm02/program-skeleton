...
void scalar_mult_add_su3_matrix(su3_matrix *a,su3_matrix *b,float s, su3_matrix *c) __attribute__ ((no_instrument_function));
void scalar_mult_add_su3_matrix(su3_matrix *a,su3_matrix *b,float s, su3_matrix *c){
